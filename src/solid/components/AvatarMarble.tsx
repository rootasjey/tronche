...
export function AvatarMarble(allProps: AvatarMarbleProps & JSX.SvgSVGAttributes<SVGSVGElement>) {
  ...
  const filterId = () => `${data().maskId}Filter`
  ...
  return (
    ...
    >
      ...
      <defs innerHTML={`<filter id="${filterId()}" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB"><feFlood flood-opacity="0" result="BackgroundImageFix"/><feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/><feGaussianBlur stdDeviation="7" result="effect1_foregroundBlur"/></filter>`} />
    </svg>
  )
}
