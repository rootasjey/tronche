  ...
  <div class="flex items-center justify-center min-h-[calc(100vh-112px)] px-5">
    <div class="w-full max-w-sm bg-surface border border-border rounded-xl p-10 text-center">
      ...
      <form class="text-left" @submit.prevent="handleRegister">
        <div class="mb-3">
          <input v-model="name" type="text" placeholder="Nom d'utilisateur" class="w-full px-3.5 py-2.5 rounded-xl bg-[var(--c-bg)] border border-border hover:text-[var(--c-text)] text-sm outline-none transition-colors focus:border-primary" />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          <input v-model="password" type="password" placeholder="Mot de passe (8+ caractères)" class="w-full px-3.5 py-2.5 rounded-xl bg-[var(--c-bg)] border border-border hover:text-[var(--c-text)] text-sm outline-none transition-colors focus:border-primary" />
        </div>
