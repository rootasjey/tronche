...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://tronche.cc' },
      ...
      link: [
        ...
        { rel: 'canonical', href: 'https://tronche.cc' },
      ],
    },
  },
  ...
  runtimeConfig: {
    ...
    emailFromAddress: process.env.NUXT_EMAIL_FROM_ADDRESS || 'Tronche <noreply@tronche.cc>',
    contactEmail: process.env.NUXT_CONTACT_EMAIL || 'support@tronche.cc',
    public: {
      authUrl: process.env.NUXT_AUTH_ORIGIN || 'http://localhost:3000',
      siteUrl: process.env.NUXT_SITE_URL || 'https://tronche.cc',
