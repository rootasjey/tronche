...
defineRouteMeta({
  openAPI: {
    ...
    description: 'Paginated list of all API keys across all users, including owner info and usage statistics.',
    ...
    responses: {
      200: { description: 'Paginated API key list with usage' },
